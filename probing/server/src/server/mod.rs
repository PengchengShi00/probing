...
fn build_app(auth: bool) -> axum::Router {
    let mut app = axum::Router::new()
        ...
        .route("/inference", axum::routing::get(index))
        .route("/rollout", axum::routing::get(index))
        .route("/train", axum::routing::get(index))
        .route("/spans", axum::routing::get(index))
        .route("/process-timeline", axum::routing::get(index))
        .route("/perfetto", axum::routing::get(index))
